...
CREATE TABLE `sections` (
  ...
  `section_number` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `sections` VALUES (1,'S1',2.00,0.00,50,30,100,1,1),(2,'S2',5.00,1.00,40,20,90,1,2),(3,'S3',3.50,2.00,30,25,70,2,1),(4,'S4',1.50,0.00,60,40,120,5,2),(5,'S5',4.00,3.00,15,10,40,4,1),(13,'S6',1.00,1.00,1,1,1,1,1),(14,'S7',1.00,1.00,1,1,1,1,1),(15,'S8',11.00,11.00,11,11,11,11,11);
