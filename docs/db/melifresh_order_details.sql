...
CREATE TABLE `order_details` (
  ...
  PRIMARY KEY (`id`),
  KEY `product_record_id` (`product_record_id`),
  KEY `purchase_order_id` (`purchase_order_id`),
  CONSTRAINT `order_details_ibfk_1` FOREIGN KEY (`product_record_id`) REFERENCES `product_records` (`id`),
  CONSTRAINT `order_details_ibfk_2` FOREIGN KEY (`purchase_order_id`) REFERENCES `purchase_orders` (`id`)
